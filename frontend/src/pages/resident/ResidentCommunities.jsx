...
import { Search, Users, MapPin, TrendingUp, Plus, UserPlus, MessageCircle } from 'lucide-react';
...
const ResidentCommunities = () => {
  ...
  // FIX: derive real stats from actual data instead of hardcoded values
  ...
  return (
    <DashboardLayout menuItems={menuItems} userType="resident">
      ...
      {/* FIX: Stats section — removed hardcoded "Active Chats: 8", replaced with real derived values */}
          ...
          <Card>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {/* FIX: was real already but kept — sum of all member_counts */}
          ...
          <Card>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                {/* FIX: was hardcoded "Active Chats: 8" — now shows real joined count */}
                <p className="text-2xl font-bold text-gray-900">{myCommunities.length}</p>
              </div>
            </div>
          </Card>
